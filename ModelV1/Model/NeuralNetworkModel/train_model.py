...
def train_and_save_model(X_train, y_train, input_shape, directory):
    tuner = RandomSearch(
    ...
    history = model.fit(X_train, y_train, epochs=200, validation_split=0.2, callbacks=[ReduceLROnPlateau()])
    ...
    r_squared_val = r2_score(y_train, val_predictions)
